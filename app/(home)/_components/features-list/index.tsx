...
const features = [
    ...
    {
        description: "Type-safe ORM with DrizzleORM, compatible with PostgreSQL, SQLite, and MySQL",
        logo: "DrizzleORMIcon",
        name: "Database ORM",
    },
    {
        description: "TypeScript enables static type checking for safer and more maintainable code.",
        logo: "TypeScriptIcon",
        name: "TypeScript",
    },
    {
    ...
    {
        description: "Authentication with Better Auth: Sign up, Sign in, Sign out, Forgot password, Reset password, and more.",
        logo: "BetterAuthIcon",
        name: "Authentication",
    },
    {
        description: "Pre-built, customizable authentication UI components for a seamless user experience.",
    ...
    {
        description: "Biome JS provides fast, all-in-one linting and formatting for JavaScript and TypeScript projects.",
        logo: "BiomeJSIcon",
