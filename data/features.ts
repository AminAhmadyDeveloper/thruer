export const groupedFeatures = [
    ...
    features: [
      {
        ...
        brandColor: "#FF00BD4D",
        link: "https://orpc.unnoq.com/docs",
      },
      {
        name: "Neon Database",
  ...
  {
    title: "Productivity & Development Tools",
    features: [
      {
        name: "Drizzle ORM",
        description:
      ...
      },
      {
        name: "React Query",
        description:
          "Effortlessly manage server state with zero configuration.",
        logo: "ReactQueryIcon",
        brandColor: "#FF41544D",
      ...
      },
      {
        ...
        logo: "AutoFormIcon",
        brandColor: "#F873164D",
        link: "https://autoform.vantezzen.io/",
      },
      {
        name: "T3 ENV",
        description:
          "Type-safe environment variables to prevent runtime errors.",
        logo: "T3ENVIcon",
        brandColor: "#FBBF244D",
        link: "https://env.t3.gg/docs/introduction",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        logo: "CodecovIcon",
        brandColor: "#ff00774D",
        link: "https://docs.codecov.com/docs",
      },
    ],
  },
  {
  ...
  {
    title: "Extra Features / Nice-to-Have",
    features: [
      {
        name: "SEO",
        description:
      ...
      },
      {
        name: "Search Params",
        description:
          "Type-safe state management for search parameters in React.",
        logo: "NuqsIcon",
        brandColor: "#6B72804D",
        link: "https://nuqs.dev/",
      },
